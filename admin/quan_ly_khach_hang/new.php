...
<form action="index.php" method="POST"  enctype="multipart/form-data">
	...
	<div class="form-group">
		...
		<input required="" type="text" class="form-control" id="" name="ten_dn" placeholder="Tên đăng nhập">
	</div>
	<div class="form-group">
	...
	<div class="form-group">
		...
		<input required="" type="text" class="form-control" id="" name="email" placeholder="Nhập email của bạn">
	</div>
	<div class="form-group">
		<label for="">Vai trò</label>
		<input required="" pattern=[0-1] type="text" class="form-control" id="" name="vai_tro" placeholder="Nhập vai trò 0 or 1">
